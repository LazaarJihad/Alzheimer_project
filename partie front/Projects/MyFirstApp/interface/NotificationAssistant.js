...
const NotificationAssistant = () => {
  ...
  const navigateToManageTimeAssistant = () => {
    navigation.navigate('ManageTimeAssistant'); // Naviguer vers l'interface ManageTimeAssistant
  };

  return (
    <View style={styles.container}>
      <TouchableOpacity style={styles.backButton} onPress={navigateToManageTimeAssistant}>
        <Image
